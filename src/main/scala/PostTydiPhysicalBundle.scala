...
class PostTydiPhysicalBundle extends Bundle{
  ...
  val post_titles: PhysicalStream = PhysicalStream(char, 1, 1, 1)
  val post_contents: PhysicalStream = PhysicalStream(char, 1, 1, 1)
  val post_author_username: PhysicalStream = PhysicalStream(char, 1, 1, 1)
  val post_tags: PhysicalStream = PhysicalStream(char, 2, 1, 1)
